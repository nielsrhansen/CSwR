...
(SHIFT+CMD+B or click *Build All* in the Build pane) will also compile 
the pdf book.
...
* Go through Section 3.5; particularly thresholding. Move penalty matrix to CSwR
* Rewrite Chapter 4. Downplay running mean, generalize to convolution, rewrite Fourier part and include convolutions using FFT, improve section on Kalman filter and smoothing.
* Figure to illustrate Example 6.1
* Rewrite Chapter 7, uniform figure usage, change network layout, finish section on particle filters.
