...
`profvis()`\index{profvis()} via the `Rprof()` function from the utils
...
a function call into any function using the base R function `trace()`, and to
...
If base R does not sport the function you need to speed up your code, you
...
of R are not typically used to this kind of side-effect from calling a function, so
it is best avoided.
