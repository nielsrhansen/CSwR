...
execution. The `foreach` package also provides a `%do%` operator, which allows
you to execute the loop sequentially, which can be useful for debugging and for
comparing the performance of the parallelized code with the sequential code.
