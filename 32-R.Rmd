...
Sometimes the bottlenecks in our R code cannot be easily mitigated by relying on
R's built-in functions. Examples include complicated for loops and recursive
functions for which there are no built-in functions to rely on. Other times,
writing performant R code can require you to sacrifice readability and
maintainability.
...
Rcpp package, which is what we will briefly introduce here.
