...
C++ code from a file. For instance, if you may in `R/my_r_experiment.R` (or
similar), call the following line:

```r
Rcpp::sourceCpp(file.path("src", "my_cpp_functions.cpp"))
```
