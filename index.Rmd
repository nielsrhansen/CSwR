...
author: "Niels Richard Hansen, Johan Larsson"
...
```{r knitr_hooks, cache=FALSE, echo=FALSE}
library(knitr)
...
The book comes with a companion R package, CSwR, which
contains datasets and utility functions that are used throughout the
book. The package is available online at <https://github.com/jolars/CSwR-Package>
and can be installed using the `remotes` package as follows:
