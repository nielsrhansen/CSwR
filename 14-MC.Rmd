...
```{r MC-CLT2, dependson=c("MC_par", "MC_loop2"), echo=FALSE, fig.cap="Histogram of the log-distribution and sample path for the Monte Carlo average ($\\alpha = 0.4$) and pointwise 95% confidence intervals based on the CLT.", out.width="100%", fig.height=3}
mu_hat <- cumsum(evaluations) / 1:N
se <- sd(evaluations) / sqrt(1:N)
