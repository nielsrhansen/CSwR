...
averages of poor precision. To remedy these challenges the subsequent sections
treat importance sampling and variations thereof, which are techniques for
simulating from a different distribution and use a *weighted* average to obtain
