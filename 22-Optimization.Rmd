...
contraction on $\mathrm{lev}(\theta_0)$ with $c = 1 - l/(L + 1) < 1$. 
...
The number $c$ quantifies how fast the iterations converge toward the fixed point.
...
of $H$ looks like a narrow ravine, this will force $\kappa^{-1}$ to be small,
